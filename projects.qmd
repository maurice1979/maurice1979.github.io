...
A selection of personal projects — mostly built to learn a technology hands-on before using it in production. For the production side of things, see [About](about.qmd).
...
[dbt]{.tag} [iceberg]{.tag} [aws-glue]{.tag} [lakehouse]{.tag} [duckdb]{.tag} [opentofu]{.tag}

[View on GitHub →](https://github.com/maurice1979/iceduck){.cta-btn .cta-secondary}
...
[dbt]{.tag} [duckdb]{.tag} [open-data]{.tag}

[View on GitHub →](https://github.com/maurice1979/xema-dbt){.cta-btn .cta-secondary}
...
[pytorch]{.tag} [deep-learning]{.tag} [computer-vision]{.tag}

[View on GitHub →](https://github.com/maurice1979/mushroom-identifier){.cta-btn .cta-secondary}
